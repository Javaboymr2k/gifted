...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Gifted~c5GCvQ5N",
  ...
  ALWAYS_ONLINE: process.env.ALWAYS_ONLINE !== undefined ? process.env.ALWAYS_ONLINE === 'true' : fslse,
  ...
  OWNER_NAME: process.env.OWNER_NAME || "𝐉𝐀𝐕𝐀 𝐁𝐎𝐘 𝐌𝐑𝟐𝐊 𝐓𝐄𝐂𝐇",
